...
class CowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cow" do
    assert_difference('Cow.count') do
      post cows_url, params: { cow: { birthday: @cow.birthday, deaddate: @cow.deaddate, deleted_at: @cow.deleted_at, key_id: @cow.key_id, name: @cow.name } }
    end
  ...
  test "should update cow" do
    patch cow_url(@cow), params: { cow: { birthday: @cow.birthday, deaddate: @cow.deaddate, deleted_at: @cow.deleted_at, key_id: @cow.key_id, name: @cow.name } }
