...
class VeterinariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veterinary" do
    assert_difference('Veterinary.count') do
      post veterinaries_url, params: { veterinary: { address: @veterinary.address, lastname: @veterinary.lastname, name: @veterinary.name } }
    end
  ...
  test "should update veterinary" do
    patch veterinary_url(@veterinary), params: { veterinary: { address: @veterinary.address, lastname: @veterinary.lastname, name: @veterinary.name } }
